...
public class StudentListActivity extends AppCompatActivity implements View.OnClickListener, EtudiantAdapter.OnEtudiantActionListener {
    ...
    private String loadUrl = "http://10.0.2.2/volley/sourcefiles/ws/loadEtudiant.php";
    private String updateUrl = "http://10.0.2.2/volley/sourcefiles/ws/updateEtudiant.php";
    private String deleteUrl = "http://10.0.2.2/volley/sourcefiles/ws/deleteEtudiant.php";
